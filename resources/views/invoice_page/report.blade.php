                ...
                <div class="col-md-12">
                    <div class="invoice-wrapper">
                        ...
                        <div class="payment-info">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2><b>Data Report</b></h2>
                                    <h5>Start Date <b>{{ $start }}-01</b></h5>
                                    <h5>End Date <b>{{$end}}-01</b></h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="line-items">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php $totalPemasukan += $o->total_harga;?>
                                    @endforeach
                                    <tr>
                                        <td colspan="4" align="right">Total Pemasukan</td>
                                        <td align="right" colspan="2">
                                            <h4 style="color: #20A720; font-weight:bold;padding:0;margin:0">Rp.
                                                {{ number_format($totalPemasukan,0,",",'.') }} </h4>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="print">
                                <a href="/admin/cetakreport?cetak=1&startdate={{$start}}&enddate={{$end}}">
